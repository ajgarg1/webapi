            ...
            try
            {
                using (CDSWebApiService svc = new CDSWebApiService(config))
                {
                    ...
                    JObject task1 = new JObject
                    {
                        ...
                        { "scheduledend", Convert.ToDateTime("4/19/2019", culture) }
                    ...
                    JObject task2 = new JObject
                    {
                        ...
                        //{ "scheduledstart", DateTimeOffset.Parse("4/20/2019") }
                        { "scheduledend", Convert.ToDateTime("4/20/2019", culture) }
                    };
                    tasks.Add(task2);
                    JObject task3 = new JObject
                    {
                        ...
                        { "scheduledend", Convert.ToDateTime("6/1/2019", culture) }
                    };
                    tasks.Add(task3);
